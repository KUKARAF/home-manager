...
}:
{
  debrid-collector = {
    ...
    version = "0.1.ca69c27";
    src = fetchurl {
      url = "https://github.com/KUKARAF/debrid_collector/releases/download/0.1.ca69c27/debrid-collector-linux-amd64.tar.gz";
      sha256 = "sha256-uVmcI74rMGPjxIlYJovGPvDLI2g3mRjWtSM1gvkDK6U=";
    };
  };
  kv-cli = {
    pname = "kv-cli";
