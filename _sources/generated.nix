...
}:
{
  debrid-collector = {
    ...
    version = "0.1.8169961";
    src = fetchurl {
      url = "https://github.com/KUKARAF/debrid_collector/releases/download/0.1.8169961/debrid-collector-linux-amd64.tar.gz";
      sha256 = "sha256-I+nx5swGQOV+vgixpEpBLYl3MBxXayb5GqqI4RPAaKE=";
    };
  };
  kv-cli = {
    pname = "kv-cli";
